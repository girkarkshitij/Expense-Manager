...
class NewExpense:
    ...
    def gui_init(self):
        ...
        self.category_options = ["Food", "Bill", "Travel", "Stationery", "Other"]
        ...
        self.submit_button.bind("<Button-1>", self.addexpense)
    ...
    def addexpense(self, event):
        ...
        options = ["Food", "Bill", "Travel", "Stationery", "Other"]
        ...
        query = "INSERT INTO expense (member_id, expense_category_id, expense_date, amount, comments) VALUES (%s, %s, " \
                "%s, %s, %s) "
